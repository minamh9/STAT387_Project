...
```{r}
GLM.Model <- function(data, train = 0.7) {
...
```{r}
glm.result <- GLM.Model(RFE.4.German)
glm.result[]

glm.pca.result <- GLM.Model(pca.four)
glm.pca.result[]

glm.result2 <- GLM.Model(RFE.10.German)
glm.result2[]

glm.pca.result2 <- GLM.Model(pca.ten)
glm.pca.result2[]

glm.result3 <- GLM.Model(RFE.4.German.balance)
glm.result3[]

glm.pca.result3 <- GLM.Model(pca.four02)
glm.pca.result3[]

glm.result4 <- GLM.Model(RFE.10.German.balance)
glm.result4[]

glm.pca.result4 <- GLM.Model(pca.ten02)
glm.pca.result4[]
```
