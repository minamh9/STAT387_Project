...
```{r}
german.lm = lm(Default ~ checkingA14, newgerman)
summary(german.lm)
german.lg = glm(Default ~ checkingA14, newgerman, family = "binomial")
summary(german.lg)
plot(german.lg)
```
...
QDA.Model <- function(data, train = 1, test = 0.5) {
  ...
  # Print the false positives percentage
  print(paste0("False positives percentage: ",
               round(false_positives_percent,3), "%"))
...
```{r}
comb_result1 <- cbind(RFE_4_feature = lda.result[2], RFE_10_feature= lda.result2[2], PC_5 = lda.pca.result[2], PC_10 = lda.pca.result2[2])
...
comb_result2 <- cbind(RFE_4_feature =lda.result3[2],RFE_10_feature=lda.result4[2],PC_5 = lda.pca.result3[2], PC_10 = lda.pca.result4[2])
...
comb_result1 <- cbind(RFE_4_feature = lda.result[1], RFE_10_feature= lda.result2[1],PC_5 = lda.pca.result[1], PC_10 = lda.pca.result2[1])
...
comb_result2 <- cbind(RFE_4_feature =lda.result3[1],RFE_10_feature=lda.result4[1],PC_5 = lda.pca.result3[1], PC_10 = lda.pca.result4[1])
